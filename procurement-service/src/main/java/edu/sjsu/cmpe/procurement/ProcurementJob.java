...
public class ProcurementJob extends Job{
	...
	@Override
	public void doJob(){
		String queueName = "/queue/64762.book.orders";
		String topic1 = "/topic/64762.book.computer";
		String topic2 = "/topic/64762.book.comics";
		String topic3 = "/topic/64762.book.management";
		String topic4 = "/topic/64762.book.selfimprovement";
		...
		try{
			...
			if(isbn_list.size() > 0){
				...
				String input = "{\"id\":\"64762\",\"order_book_isbns\":[";
