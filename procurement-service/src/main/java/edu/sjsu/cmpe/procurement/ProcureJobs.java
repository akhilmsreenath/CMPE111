...
public class ProcureJobs extends Job{
	...
	public String consumer() throws JMSException{
		...
		Destination dest = new StompJmsDestination("/queue/96762.book.orders");
		MessageConsumer consumer = session.createConsumer(dest);
		System.out.println("Waiting for messages from " + "/queue/96762.book.orders" + "...");
		String temp1="";
		while(true) {
	...
	void domsgpost(String str)
	{
		try {
			...
			String input="{\"id\" :\"96762\",\"order_book_isbns\":["+str+"]}";
    	...
    	public ArrayList<String> getBooksFromPulisher() throws JSONException
    	{
    		ArrayList<String> library1=new ArrayList<String>();
    			...
    			Client client = Client.create();
    			WebResource webResource=client.resource("http://54.215.133.131:9000/orders/96762");
    	...
    	public void publisher(ArrayList<String>books) throws JMSException
    	{
    		...
    		String host = "54.215.133.131";
    		int port = Integer.parseInt("61613");
    		String destination_a = "/topic/96762.book.all";
    		String destination_b="/topic/96762.book.computer";
